...
def get_bodhi_setting():
    logger.info('check site settings')
    value = cache.get('get_bodhi_setting')
    if value:
        return value
    else:
        ...
        logger.info('set cache get_bodhi_setting')
        cache.set('get_bodhi_setting', value)
        return value
