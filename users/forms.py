...
class UserInfoForm(ModelForm):
    class Meta:
        ...
        fields = ['user_num', 'account', 'company', 'department', 'team', 'title', 'parent_email', 'telephone', 'mobilephone', 'description']
        widgets = {
            ...
            'department': widgets.TextInput(attrs={'class': 'layui-input', 'placeholder': '部门'}),
            'team': widgets.TextInput(attrs={'class': 'layui-input', 'placeholder': '团队'}),
