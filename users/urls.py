...
urlpatterns = [
    ...
    url(r'^user/changeinfo$', views.change_user_info, name='changeuserinfo'),
    url(r'^manage/user/$', views.userlist, name='userview'),
    url(r'^manage/user/list/$', views.user_list_manage, name='userlist'),
    ...
    url(r'^manage/imgupload/$', views.upload_image, name='imgupload'),
]
